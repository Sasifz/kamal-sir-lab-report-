...
int main()
{
    ...
    {
        new Birthday(19,9,1997),
        new Birthday(21,07,1999),
        new Birthday(17,12,1993),
        new Birthday(20,03,1988,
    };

    Student *s[3]=                               ///Student type object declaration
    {
        new Student("rahim",dt[0],dp[0],1001,4,301),
        new Student("alauddin",dt[1],dp[1],1002,4,400),
        new Student("kabir",dt[2],dp[2],1003,2,200)
    };

    Faculty *f[2]=                                ///faculty object declaration.
    {
        new Faculty("kamal","Professor",dp[3]),
        new Faculty("foysal","Lecturer",dp[4])
    };
